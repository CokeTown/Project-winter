...
> **2026-07-16 갱신: 172장 중 129장이 모노 정본으로 완료**(pixelarticons MIT 25 + 자작 91 + 재사용 — tools/icon-mono-gen.mjs가 패스 정본).
> 이 리스트는 이제 "디렉터가 갈아끼우고 싶은 것만" 선택 교체용이다. 납품 경로(assets-src/art/dot/)와 규격은 유효.
