...
- **디렉터 확정 정가 $9.99 + 론치 -15% → ≈$8.49.** 근거: 게임 적대적 리뷰([../design/GAME-REVIEW.md](../design/review/GAME-REVIEW.md))가 $11.49를 "idle 밴드(Rusty's $6.99·Melvor $9.99) 초과 + 얇은 볼륨"의 데드존으로 판정. 디렉터 논리 — **"2.0(무료) 완료 시 사실상 본편 분량"** — 이 $9.99를 장기값으로 정당화(Steam 정가 인상은 껄끄러우니 처음부터 장기값으로 박음).
