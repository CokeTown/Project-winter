# Nine Winters — 스팀 페이지 카피 (ko/en)

> 기준: GD-THESIS 한 문장 "세상이 끝나도, 삶은 계속 손질할 수 있다" / 태그라인 "폐허에도 온기는 남아 있다".
> 카피 리트머스(THESIS §6) 자체검증은 문서 하단. 지시조 금지·keep-all·병치 공식(회색 세계 × 앰버 온기).

---

## 1. 짧은 설명 (Short Description, 300자 이내)
...
## 2. 긴 설명 (About This Game)

### KO

<p style="word-break:keep-all">
눈은 그치지 않는다. 도시는 잿빛으로 얼어붙었고, 거리에는 아무도 남지 않았다. 그 폐허 한가운데, 당신의 셸터에는 아직 불이 켜져 있다.
</p>

<p style="word-break:keep-all">
<b>Nine Winters</b>는 구원을 팔지 않는다. 세계는 이미 끝났으니까. 대신 회복의 가장 작은 단위를 건넨다 — 데운 수프 한 캔, 고쳐 단 슬레이트 한 장, 난로 앞에 몸을 만 고양이, 지지직거리는 라디오 한 채널. 매일의 손질이 쌓여 온기가 되고, 그 온기만이 이 폐허에서 유일하게 머무는 것이 된다.
</p>

<p style="word-break:keep-all">
밀수꾼도, 먼 불빛도, 문 앞에 꾸러미를 두고 간 누군가도 흐른다. 머무는 건 당신이 손수 지핀 것뿐. 실패해도 죽지 않는다 — 그저 조금 덜 온전한 하루가 지날 뿐이다. 재촉하지 않는 세계에서, 아홉 번의 겨울을 당신의 속도로 지나가면 된다.
</p>

<b>이 폐허에서 할 수 있는 것</b>

- <b>아홉 번의 겨울</b> — 계절이 흐르고, 버틴 시간이 세어진다. 여름의 부패, 겨울의 봉쇄, 한파의 성에 — 준비의 긴장과 해소가 계절마다 반복된다.
- <b>손질과 꾸미기</b> — 벽지·바닥·테마로 셸터를 나만의 집으로. 비어 있던 컨테이너가 하나둘 채워지고, 그 변화가 수첩에 "그 해 겨울"로 남는다.
- <b>난로 앞의 고양이</b> — 쓰다듬으면 눈을 감는다. 위안은 고양이가, 일은 개가 — 동물은 흐르지 않고 곁에 머무는 유일한 예외다.
- <b>네 개의 지평선</b> — 얼어붙은 항구, 발밑의 지하 노선, 오로라 뜨는 고원, 그리고 금지 구역. 정식 출시 이후 네 번의 무료 확장으로 셸터에서 닿는 세계가 넓어진다.
- <b>다섯 가지 방식</b> — 느긋한 노말, 시험 같은 하드, 구제 없는 하드코어, 끝도 재촉도 없는 무한, 그리고 압박을 다 겪은 이에게 열리는 배경화면 모드. 저마다 다른 방식으로 온기를 묻는다.
- <b>바탕화면 위젯</b> — 꾸민 집을 바탕화면에 켜둔다. 눈이 내리고 난롯불이 흔들리는 동안, 당신의 온기가 데스크톱 한구석에 머문다.

<p style="word-break:keep-all">
사망 연출은 없다. 몰아세우는 손도 없다. 여기 있는 건 초대뿐이다 — 세상이 끝난 뒤에도, 삶은 계속 손질할 수 있다는 초대.
</p>
...
- **A cat by the stove** — Pet it, and it closes its eyes. The cat is comfort, the dog is work — animals are the one exception that stays rather than drifts.
...
> **아늑함(Cozy)·건전함(Wholesome)은 마법사 「테마 및 분위기」 단계에 실존** — 자유검색 불요(2026-07-11 실물 확인).
> 여유분/러너업(20 초과 시): 선택의 중요성, 깊은 세계관, 인디, 아이소메트릭, 웅장한 사운드트랙, 컨트롤러, 미스터리.
...
### KO
<p style="word-break:keep-all">
<b>첫 번째 겨울.</b> 데모에서는 셸터 하나에 불을 지피고, 눈이 도시를 덮는 48일을 지나본다. 수프를 데우고, 벽을 고치고, 고양이를 곁에 두는 하루의 결이 여기 다 있다.<br>
Day 48, 첫 겨울의 끝에서 화면이 잠시 멈춘다. — <b>여덟 번의 겨울이 남아 있다.</b>
</p>

### EN
**The first winter.** The demo lights one shelter and carries you through the 48 days as snow buries the city. The texture of a day — warming the soup, mending a wall, keeping the cat close — is all here.
At Day 48, the end of the first winter, the screen holds still for a moment. — **Eight winters remain.**
...
### KO
<p style="word-break:keep-all">
눈은 그치지 않고, 도시는 잿빛으로 얼었다. 그래도 난롯불은 지필 수 있다. 폐허 속 셸터를 손질하며 아홉 번의 겨울을 나는 코지 생존 — 첫 번째 겨울을 지금 데모로.
</p>

### EN
Snow does not stop, and the city has frozen grey. Even so, the stove still lights. A cozy survival about tending a shelter through nine winters in the ruins — play the first winter now in the demo.

---

## 6. 카피 리트머스 자체검증 (THESIS §6)

| 질문 | 판정 | 근거 |
|---|---|---|
| ① 온기를 **만들·쌓·돌아보게** 하는가? | 통과 | 짧은 설명("회복은 습관"), 긴 설명 불릿 전부가 손질→축적→회고(수첩 "그 해 겨울") 축으로 정렬. |
| ② 몰아세우는가, **초대**하는가? | 통과 | 지시조("~하라") 0건. "지나가면 된다 / 초대뿐이다"로 마감. 명령형 대신 서술·청유. |
| ③ 타인이 **머무는가?** | 통과(캐논 준수) | 밀수꾼·먼 불빛·문 앞의 누군가 모두 "흐른다"로 명시. 머무는 건 "손수 지핀 온기"와 동물(정착의 예외)뿐. |

추가 점검: 병치 공식(회색 세계 × 앰버 온기) — 모든 문단이 "잿빛 도시/폐허" + "난롯불/수프/고양이/불빛"을 한 문장 안에 병치. keep-all 조판 적용(word-break:keep-all). 이모지는 모드명 배지(게임 내 문법)에서만 예외 허용, 본문 카피에는 미사용.
