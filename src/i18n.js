...
export const STR = {
  ...
  'bunker.roofStage1Btn':{ ko: '🛠️ 임시 덮개 씌우기 (건축재 2)', en: '🛠️ Put up a cover (2 material)' },
  'bunker.roofStage2Btn':{ ko: '🛠️ 완전 수리 (건축재 4)', en: '🛠️ Full repair (4 material)' },
  ...
  'bunker.backdoorFound':{ ko: '절단기를 손에 넣었다. 벙커 뒷벽을 뚫어 저장고를 열 수 있다.', en: 'Got hold of a cutter. I can breach the back wall and open a storeroom.' },
  'bunker.backdoorBtn': { ko: '🔩 절단기로 뒷문 저장고 열기', en: '🔩 Cut open the back storeroom' },
  'bunker.backdoorDone':{ ko: '뒷벽을 갈라 저장고를 열었다. 벙커가 한층 든든해졌다. <b>(쾌적 +4)</b>', en: 'Cut through the back wall and opened the storeroom. The bunker feels far more secure. <b>(comfort +4)</b>' },
