...
export const STR = {
  ...
  'btn.knowledge.title': { ko: '지식 (테크트리)', en: 'Knowledge (tech tree)' },
  'btn.clean.title':  { ko: '청소 (물 1 → 청결 +20)', en: 'Clean (water 1 → cleanliness +20)' },
  'know.title':       { ko: '지식', en: 'Knowledge' },
  'know.books':       { ko: '📚 책 {n}권 — 지식을 배워 살림을 키운다', en: '📚 {n} books — learn to better your home' },
  'know.cost':        { ko: '{n}권', en: '{n} bk' },
  'know.learn':       { ko: '배우기 ({n}권)', en: 'Learn ({n} bk)' },
  'know.learned':     { ko: '✓ 익힘', en: '✓ Learned' },
  'know.locked':      { ko: '🔒 선행 필요', en: '🔒 Prereq needed' },
  ...
  // 액션 아이콘 아래 상시 라벨 (디렉터: 아이콘만으론 뭔지 모름 — 작게 병기)
  'btn.exp.lbl':       { ko: '탐험', en: 'Explore' },
  'btn.move.lbl':      { ko: '이주', en: 'Move' },
  'btn.craft.lbl':     { ko: '제작', en: 'Craft' },
  'btn.knowledge.lbl': { ko: '지식', en: 'Tech' },
  'btn.clean.lbl':     { ko: '청소', en: 'Clean' },
  'btn.wardrobe.lbl':  { ko: '옷장', en: 'Wardrobe' },
  'btn.sleep.lbl':     { ko: '취침', en: 'Sleep' },
  'btn.journal.lbl':   { ko: '일지', en: 'Journal' },
  'btn.help.lbl':      { ko: '도움', en: 'Help' },
  ...
  'exp.note.book':    { ko: '📕 물에 젖지 않은 책 한 권을 챙겼습니다 — 폐허에 남은 지식.', en: '📕 You salvaged a book that survived the damp — knowledge left in the ruins.' },
  ...
  'day.surplusSold':  { ko: '📕 남아도는 식량을 암시장에 내다 팔아 책 {b}권을 얻었습니다. (식량 -{n})', en: '📕 Traded surplus food at the black market for {b} book(s). (food -{n})' },
