...
export const CAT_POSES = {
  ...
  sit:     { by: 0.03,  brx: -0.40, hrx: 0.14, legF: -0.30, legB: -0.40, t1: -0.65 }, // 디렉터(2026-07): MC 앉기 — 앞발 앞으로(legF −0.3)·엉덩이 낮게(by↓·뒷다리 무릎접힘 cat.js _shin/_bpiv). legB는 허벅지각(정강이가 접음)
  ...
  sprawl:  { by: 0.02,  brx: 0,     hrx: -0.3,  legF: -0.15, legB: 0.15,  t1: -0.1 }, // 디렉터(2026-07): superman 엎드리기 — 앞다리 앞·뒷다리 뒤로 쭉 뻗어 접지(cat.js 앞팔 _fore/정강이 _shin 관절). 배 바닥밀착
