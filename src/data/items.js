...
export const CAT_POSES = {
  ...
  sit:     { by: 0.06,  brx: -0.40, hrx: 0.14, legF: -0.05, legB: -1.25, t1: -0.65 },
  ...
  sprawl:  { by: 0.03,  brx: 0,     hrx: -0.05, legF: 0,     legB: 0,     t1: -0.5 }, // 디렉터 신고(2026-07 라이브): 앞뒤 접힘이 다리를 위로 세움 → 0(수직 아래). 양수(뒤뻗기)=발바닥노출·음수=위로솟음, 0만 아래로
  ...
  stretch: { by: 0.17,  brx: 0.6,   hrx: -0.4, legF: -0.15, legB: 0.1,   t1: 0.35 }, // 디렉터(2026-07 확대): 진짜 기지개 ㄴ자 — legF(상완) 거의 수직 + 전완 마디를 앞으로 접어(cat.js _fore) 앞팔 바닥 전방 납작
