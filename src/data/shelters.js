...
export const SHELTER_META = {
  ...
  bunker: {
    ...
    perk: { injuryHalf: true, label: '두꺼운 외피 — 부상 회복 2배 빠름', labelEn: 'Thick shell — injuries heal twice as fast' },
  },
  rooftop: {
    name: '도시 옥탑방', nameEn: 'City Rooftop', emoji: '', unlockAt: 25, viewH: 19, ceilY: 2.5,
  ...
  cabin: {
    ...
    perk: { cozyMult: 1.5, label: '아늑한 구조 — 쾌적함 효과 1.5배', labelEn: 'Cozy layout — comfort effects ×1.5' },
    room: { w: 10, d: 8, h: 2.7 },
  ...
  subway: {
    ...
    weatherPool: ['clear'],
    perk: { lightMult: 1.5, label: '어둠 속 안식 — 조명 쾌적함 효과 1.5배', labelEn: 'Rest in the dark — lighting comfort effect ×1.5' },
  ...
  greenhouse: {
    ...
    limits: '유리 지붕 — 눈 오는 날엔 건축재 1로 보수 (없으면 청결 -8)', limitsEn: 'Glass roof — snowy days need 1 material to patch (else cleanliness -8)',
  ...
  lighthouse: {
    ...
    limits: '옥상 빗물받이 — 비/눈 오는 날 깨끗한 물 +2 (자급 가능)', limitsEn: 'Rooftop rain catch — clean water +2 on rainy/snowy days (self-sufficient)',
  },
  tugboat: {
    name: '요트', nameEn: 'Yacht', emoji: '', unlockAt: 230, viewH: 16, ceilY: 2.3,
  ...
  controltower: {
    ...
    moveCost: { parts: 27, material: 27 }, limits: '사방 유리 — 비/눈 오는 날 쾌적함 -6', limitsEn: 'Glass on all sides — comfort -6 on rainy/snowy days', cold: 6,
    noWallpaper: true, // (B-①) 사방 유리 전망 벽 — 벽지 미대상. 바닥재만 가능.
  },
  lodge: {
    name: '스키 로지', nameEn: 'Ski Lodge', emoji: '', unlockAt: 290, viewH: 20, ceilY: 3.0,
    ...
    limits: '고도 — 연료 소모 +30% · 한파가 더 잦다 (로지 단열·벽난로가 상쇄)', limitsEn: 'Altitude — fuel use +30% · cold snaps more frequent (offset by lodge insulation & hearth)',
  ...
  customs: {
    ...
    limits: '심사 창구로 바람이 든다 — 악천후 쾌적 -5 (창구 봉쇄로 해소)', limitsEn: 'Wind slips through the booths — comfort -5 in bad weather (fix by sealing them)',
  },
  ...
  terminal: {
    ...
    cold: 4, limits: '무너진 천장 — 악천후 쾌적 -4 (지붕 틈을 막으면 해소)', limitsEn: 'Broken ceiling — comfort -4 in bad weather (fix by patching the gap)',
  },
  ...
  penthouse: {
    name: '펜트하우스', nameEn: 'Penthouse', emoji: '', unlockAt: 9999, viewH: 22, ceilY: 2.9,
    ...
    perk: { label: '첨탑들의 왕좌 — 도시 전체가 창밖에 있다', labelEn: 'A throne among spires — the whole city hangs in the window' },
    moveCost: { material: 40, parts: 32 },
    limits: '고층 강풍 — 겨울 바람이 유리를 두드린다', limitsEn: 'High-rise wind — winter rattles the glass',
  },
};
