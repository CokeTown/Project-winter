...
export const BAL = {
  ...
  events: {
    ...
    riskExpChance: 0.11,   // 탐험당 리스크 인카운터(무너진 입구) 발동 확률 — cozy 기준 11%(디렉터 2026-07-19: 0.22 너무 잦다·보상이 죄다 보라 도료라 단조 → 절반으로). ~9탐험에 1번 꼴
    riskDeepMul: 1.5,      // #167 뒷골목 심부 배수 — 속은 자주 무너진다 (0.22×1.5=0.33)
    crtExpChance: 0.08,    // CRT 단말(아직 돌아가는 콘솔) 발동 확률 — 실내 4지역 한정이라 체감은 더 드물다. 리스크(0.11)보다 낮게: 만날 때마다 사건이면 '아직 켜져 있음'의 값이 준다
    crtParts: [2, 4],      // CRT 분해 수확 부품 수(균등 2~4) — 디렉터 2026-07-25 "부품을 여러 개". 무너진 입구 잡동사니(1~2)보다 후한 값 = 마지막 기록을 포기한 대가
    crtBatteryChance: 0.35, // 분해 시 백업 전지 생존 확률 (+배터리 1)
