...
const AERIAL_KEYS = [
  ...
  // 낮 구간 상향(디렉터 2026-07-22: "CRT여도 시간대 광원이 읽혀야 — 건조한 위성사진 금지").
  //   잿빛 정체성은 유지하되 낮은 낮답게 — 밤/노을과의 대비가 '생동'을 만든다. 실측 42/255 → 목표 70+.
  [7,  0x465062, 0x3e4656, 0x72809c, 0x202430, 0xe8b070, 0.85, 12, 0.25],
  [9,  0x6a7484, 0x5c6474, 0x8c98ac, 0x323844, 0xe8e2d2, 1.35, 30, 0.0],
  [15, 0x646c7e, 0x565e6e, 0x8691a5, 0x2e3440, 0xdcd4c6, 1.25, 26, 0.0],
  [18, 0x5a3346, 0x4a2c3c, 0x6a4a60, 0x1a1420, 0xff8040, 0.62, 8,  0.35],
