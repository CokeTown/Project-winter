...
const G = {
  ...
  icon_res_food: '<path d="M3,11 H21 A9,7 0 0,1 3,11 Z"/><rect x="10.5" y="4" width="1.6" height="5" rx="0.8"/><rect x="13" y="4" width="1.6" height="5" rx="0.8"/>', // 그릇 + 김
  ...
  icon_res_antiseptic: '<path d="M9,9 H15 V21 H9 Z"/><path d="M10,4 H13.5 V9 H10 Z"/><path d="M13.5,4 H17.5 V6 H13.5 Z"/>', // 분무병 + 노즐
  ...
  icon_res_salt: '<path fill-rule="evenodd" d="M8,9 H16 V20.5 H8 Z M9.5,4 H14.5 V9 H9.5 Z M10.3,11 h1 v1 h-1 Z M12.5,11 h1 v1 h-1 Z M10.3,13.5 h1 v1 h-1 Z M12.5,13.5 h1 v1 h-1 Z"/>', // 소금통 + 구멍
  // ── 액션 (act) ── 게임 문법 필수
  icon_act_explore: '<path fill-rule="evenodd" d="M7.5,7 A4.5,4.5 0 0,1 16.5,7 V8.2 H14.5 A2.5,2.5 0 0,0 9.5,8.2 H7.5 Z M5,8 H19 V19.5 A1.5,1.5 0 0,1 17.5,21 H6.5 A1.5,1.5 0 0,1 5,19.5 Z M9.5,11.5 H14.5 V15.5 H9.5 Z"/>', // 배낭: 손잡이+몸통+앞주머니 홀
  ...
  icon_act_clean: '<g transform="rotate(-28 12 12)"><rect x="10.6" y="2.5" width="2.6" height="11"/><path fill-rule="evenodd" d="M8,13.5 H16 L17.6,21 H6.4 Z M9.9,16.5 h0.9 v4 h-0.9 Z M12.4,16.5 h0.9 v4 h-0.9 Z"/></g>', // 빗자루: 자루+빗살(홀)
  ...
  icon_act_wardrobe: '<path d="M8,4 L4,7 L6.2,10 L8.5,8.3 V20.5 H15.5 V8.3 L17.8,10 L20,7 L16,4 C15,6 13.5,6.6 12,6.6 C10.5,6.6 9,6 8,4 Z"/>', // 티셔츠
  ...
  icon_sys_save: '<path fill-rule="evenodd" d="M4,4 H16 L20,8 V20 H4 Z M8,5 H14 V9 H8 Z M7,13 H17 V19 H7 Z"/>', // 플로피 + 셔터(홀) + 라벨(홀)
  ...
  icon_g_clean: '<g transform="rotate(-28 12 12)"><rect x="10.6" y="2.5" width="2.6" height="11"/><path d="M8,13.5 H16 L17.6,21 H6.4 Z"/></g>', // 빗자루(청결)
  ...
  icon_weather_rain: '<path d="M6.5,14 A4,4 0 0,1 7.5,6.3 A5.2,5.2 0 0,1 17.5,7.5 A3.6,3.6 0 0,1 17.3,14 Z"/><path d="M8,16.5 L6.5,20.5 A0.9,0.9 0 0,0 8.3,20.5 Z"/><path d="M12,16.5 L10.5,20.5 A0.9,0.9 0 0,0 12.3,20.5 Z"/><path d="M16,16.5 L14.5,20.5 A0.9,0.9 0 0,0 16.3,20.5 Z"/>', // 구름 + 비
  ...
  // ── 계절 (season) ──
  icon_season_spring: '<rect x="11" y="10" width="2" height="11"/><path d="M11.5,12 C4.5,12 4,4.5 4,4.5 C11.5,4.5 11.5,12 11.5,12 Z"/><path d="M12.5,15 C18.5,15 19,8.5 19,8.5 C12.5,8.5 12.5,15 12.5,15 Z"/>', // 새싹: 줄기 + 잎 2
  ...
  icon_season_autumn: '<path d="M12,3.5 C17,7 19,11 19,14.5 A7,7 0 0,1 5,14.5 C5,11 7,7 12,3.5 Z"/><rect x="11.2" y="12" width="1.6" height="9"/>', // 낙엽
  ...
  icon_rec_radio: '<path fill-rule="evenodd" d="M4,9 H20 V20 H4 Z M9,12.1 A2.4,2.4 0 1,0 9,16.9 A2.4,2.4 0 1,0 9,12.1 Z M14,12 H17 V13.4 H14 Z M14,15 H17 V16.4 H14 Z"/><path d="M6,9 L15,4 L15.8,5.5 L8.5,9 Z"/>', // 라디오 + 스피커·다이얼(홀) + 안테나
  icon_rec_sketch: '<path fill-rule="evenodd" d="M4.5,4.5 H19.5 V19.5 H4.5 Z M7,16 L11,11 L13.5,14 L15.5,12 L17,15 V17 H7 Z M9.5,7.5 A1.5,1.5 0 1,0 9.5,10.5 A1.5,1.5 0 1,0 9.5,7.5 Z"/>', // 사진 프레임(산+해)
  // ── 전리품 (loot) ──
