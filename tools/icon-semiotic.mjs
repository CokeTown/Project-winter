...
const G = {
  ...
  // 구름 = 캡슐(수평 라운드 사각) — 유기 3호 뭉게 실루엣 폐기, 콥식 기하 원형. 강하물이 종을 구분한다.
  icon_weather_snow: '<rect x="4" y="7" width="16" height="7" rx="3.5"/><rect x="7" y="17" width="2.2" height="2.2"/><rect x="11" y="19.5" width="2.2" height="2.2"/><rect x="15" y="17" width="2.2" height="2.2"/>', // 캡슐 구름 + 눈(사각 플레이크)
  icon_weather_rain: '<rect x="4" y="7" width="16" height="7" rx="3.5"/><path d="M8.6,16.5 L7,21 H8.8 L10.4,16.5 Z"/><path d="M12.6,16.5 L11,21 H12.8 L14.4,16.5 Z"/><path d="M16.6,16.5 L15,21 H16.8 L18.4,16.5 Z"/>', // 캡슐 구름 + 45° 빗금 3
  icon_weather_storm: '<rect x="4" y="5.5" width="16" height="7" rx="3.5"/><path d="M13.5,14 L8,20.5 H11 L9.5,23.5 L16,16.5 H13 L14.5,14 Z"/>', // 캡슐 구름 + 번개
  icon_weather_ash: '<rect x="4" y="7" width="16" height="7" rx="3.5"/><circle cx="8" cy="18" r="1.1"/><circle cx="12" cy="20.3" r="1.1"/><circle cx="16" cy="18" r="1.1"/>', // 캡슐 구름 + 재(점)
  // ── 시간대 (time) ──
  ...
  // ── 계절 (season) ──
  icon_season_spring: '<rect x="11.1" y="9" width="1.8" height="12"/><path d="M11.1,12 L4.5,8 L4.5,4 L11.1,8 Z"/><path d="M12.9,15 L19.5,11 L19.5,7 L12.9,11 Z"/>', // 새싹 — 45° 평행사변형 잎 2(유기 곡선 소거)
  ...
  icon_season_autumn: '<path fill-rule="evenodd" d="M12,2.5 L19.5,10 L12,17.5 L4.5,10 Z M11.3,5.6 H12.7 V14.4 H11.3 Z"/><rect x="11.3" y="15" width="1.4" height="6.5"/>', // 낙엽 — 마름모+중륵 홀(유기 곡선 소거)
