...
const G = {
  ...
  // #223 재제작(디렉터 레퍼런스: 제리캔): 불꽃은 11px에서 water 물방울과 수렴 — 실물 연료통(캡+핸들 슬롯+X 리세스)
  icon_res_fuel: '<path fill-rule="evenodd" d="M6.5,3.5 H9.5 V5.5 H19 V19 A1.5,1.5 0 0,1 17.5,20.5 H6.5 A1.5,1.5 0 0,1 5,19 V5.5 H6.5 Z M8,7.2 H16.5 V8.8 H8 Z M7.4,10.8 L9,10.8 L17,18.4 L15.4,18.4 Z M15.4,10.8 L17,10.8 L9,18.4 L7.4,18.4 Z"/>', // 제리캔: 좌상단 캡 + 핸들 슬롯 홀 + X 리세스 홀
  icon_res_material: '<path d="M4,15 H20 V19.5 H4 Z"/><path d="M6,10 H18 V14 H6 Z"/><path d="M8,5 H16 V9 H8 Z"/>', // 적재 블록 3단
  // #223 재제작 2차(디렉터 레퍼런스): 위에서 접혀 두 갈래로 늘어진 천 — 좌판 짧고 우판 길게(자연 드레이프)
  icon_res_cloth: '<path d="M4,5.5 H20 V19 H12.2 V8.2 H10.8 V17.5 H4 Z"/>', // 접힌 천 두 겹(상단 연결·하단 어긋남)
