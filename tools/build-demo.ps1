...
# [guard] Demo freeze+guard (#175, review rank-1). This branch (demo-vertical-slice) is the frozen
# shipping demo source-of-truth (Day-15 cut). gd-2.0 trunk carries a divergent demo path (its old
# Day-37 gate was an always-false seasonOf-object===string bug), so a demo built there would never
# cut / show credits / show the wishlist CTA. Refuse to build off any other branch, and fail on the
# known breakages before packaging.
